...
class Customweb_Saferpay_Authorization_Server_ParameterBuilder extends Customweb_Saferpay_AbstractParameterBuilder {
	...
	public function __construct(Customweb_Saferpay_Authorization_Transaction $transaction, Customweb_Saferpay_Configuration $configuration, Customweb_DependencyInjection_IContainer $container) {
		parent::__construct($transaction->getTransactionContext(), $configuration);
		$this->transaction = $transaction;
	}
	
	
	public function buildVerifyEnrollmentParameters($parameters){
