...
class Customweb_SaferpayCw_Model_OrderContext extends Customweb_Payment_Authorization_OrderContext_AbstractDeprecated implements Customweb_Payment_Authorization_IOrderContext
{
	/**
	 * Transient fields
	 */
	...
	/**
	 * 
	 * @param Customweb_SaferpayCw_Model_Method $paymentMethod
	 * @param unknown $isOrderAvailable
	 */
	public function __construct(Customweb_SaferpayCw_Model_Method $paymentMethod, $isOrderAvailable, $storeId = null, $quote = null)
	{
	...
	{
		$orderContext = new Customweb_SaferpayCw_Model_OrderContext($order->getPayment()
	...
	{
		return Mage::getModel('saferpaycw/invoiceItems')->getInvoiceItems($this->getOrderQuote(), $this->getStore()->getStoreId(), $this->useBaseCurrency());
	}
