...
class Customweb_SaferpayCw_Model_Source_SaferpayTestCardAuthorizationMethod
{
	public function toOptionArray()
	{
		$options = array(
			...
			array('value' => 'ServerAuthorization', 'label' => Mage::helper('adminhtml')->__("Server Authorization (Authorization Interface)")),
