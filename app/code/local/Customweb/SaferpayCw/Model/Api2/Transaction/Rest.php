...
class Customweb_SaferpayCw_Model_Api2_Transaction_Rest extends Customweb_SaferpayCw_Model_Api2_Transaction
{
	...
	{
		$transaction = Mage::getModel('saferpaycw/transaction')->load($id);
