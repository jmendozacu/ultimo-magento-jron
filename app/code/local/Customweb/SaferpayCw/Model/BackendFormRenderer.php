...
class Customweb_SaferpayCw_Model_BackendFormRenderer extends Customweb_Form_Renderer
{
	private $formId = null;
	...
	{
		if (Mage::getModel('saferpaycw/configurationAdapter')->getStoreHierarchy() == null) {
			return '';
		}
