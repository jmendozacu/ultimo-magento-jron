...
class Customweb_SaferpayCw_Model_Method_MyOne extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_myone';
	protected $paymentMethodName = 'myone';
