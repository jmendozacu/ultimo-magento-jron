...
class Customweb_SaferpayCw_Model_Method_BonusCard extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_bonuscard';
	protected $paymentMethodName = 'bonuscard';
