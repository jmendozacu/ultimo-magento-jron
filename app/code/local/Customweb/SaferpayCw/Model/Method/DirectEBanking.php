...
class Customweb_SaferpayCw_Model_Method_DirectEBanking extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_directebanking';
	protected $paymentMethodName = 'directebanking';
