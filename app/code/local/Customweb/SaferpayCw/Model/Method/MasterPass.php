...
class Customweb_SaferpayCw_Model_Method_MasterPass extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_masterpass';
	protected $paymentMethodName = 'masterpass';
