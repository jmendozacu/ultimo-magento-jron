...
class Customweb_SaferpayCw_Model_Method_LaserCard extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_lasercard';
	protected $paymentMethodName = 'lasercard';
