...
class Customweb_SaferpayCw_Model_Method_DirectDebits extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_directdebits';
	protected $paymentMethodName = 'directdebits';
