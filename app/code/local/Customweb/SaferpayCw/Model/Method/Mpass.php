...
class Customweb_SaferpayCw_Model_Method_Mpass extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_mpass';
	protected $paymentMethodName = 'mpass';
