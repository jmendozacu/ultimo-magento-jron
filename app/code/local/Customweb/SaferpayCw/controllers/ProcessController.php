...
class Customweb_SaferpayCw_ProcessController extends Customweb_SaferpayCw_Controller_Action
{
	...
	public function dummyAction()
	{
		...
		$this->getLayout()->getBlock('content')->append(
			$this->getLayout()->createBlock('saferpaycw/dummy')
		);
	...
	public function getVisibleFieldsAction()
	{
		...
		if($payment != null){
			...
			$this->getHelper()->log("SaferpayCw : ProcessController::getVisibleFieldsAction() Could not find payment method '" . $_REQUEST['payment_method']);
			$html = Mage::helper("SaferpayCw")->__("Technical issue: This payment methods is not available at the moment.");
		}
