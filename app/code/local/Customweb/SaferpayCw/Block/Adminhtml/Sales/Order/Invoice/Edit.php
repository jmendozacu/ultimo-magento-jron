<?php
class Customweb_SaferpayCw_Block_Adminhtml_Sales_Order_Invoice_Edit  extends Mage_Adminhtml_Block_Widget_Form_Container
{
	public function __construct()
    {
        $this->_objectId = 'order_id';
        $this->_controller = 'customweb_saferpaycw_invoice';
        $this->_mode = 'edit';
