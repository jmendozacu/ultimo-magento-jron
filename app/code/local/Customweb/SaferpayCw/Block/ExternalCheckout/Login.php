...
class Customweb_SaferpayCw_Block_ExternalCheckout_Login extends Mage_Core_Block_Template
{
	private $_context;
	...
	{
		parent::_construct();
		$this->setTemplate('customweb/saferpaycw/external_checkout/login.phtml');
	}
	...
	{
		return Mage::getUrl('SaferpayCw/Externalcheckout/loginPost', array('_secure'=>true));
	}
	
	public function getRegisterPostAction()
	{
		return Mage::getUrl('SaferpayCw/Externalcheckout/registerPost', array('_secure'=>true));
	}
