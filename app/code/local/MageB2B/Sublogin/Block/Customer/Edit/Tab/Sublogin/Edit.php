...
class
MageB2B_Sublogin_Block_Customer_Edit_Tab_Sublogin_Edit
extends
...
'label'
=>
$this->__('Save and Continue Edit'),
'onclick'
=>
'saveAndContinueEdit()',
'class'
...
{
if
(Mage::registry('subloginModel')->getId())
return
Mage::helper('sublogin')->__('Edit sublogin %s for customer %s',
...
{
return
Mage::helper('sublogin')->__('Add new sublogin for customer %s',
$this->escapeHtml(Mage::registry('current_customer')->getName()));
}
}
}
