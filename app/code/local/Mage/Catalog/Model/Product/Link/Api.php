        ...
        if ($type == "associated")
        {
            ...
            foreach ($products as $associatedProduct) {
                $row = array(
                    ...
                    'type'       => $associatedProduct->getTypeId(),
                    'set'        => $associatedProduct->getAttributeSetId(),
                    'sku'        => $associatedProduct->getSku(),
                    'ean'        => $associatedProduct->getEan(),
                    'primary_size' => $associatedProduct->getPrimarySize(),
                    'secondary_size' => $associatedProduct->getSecondarySize(),
                    'parent_id'  => $productId,
                );
                $result[] = $row;
            }
