...
class Iksanika_OneStepCheckout_AjaxController 
    extends Mage_Core_Controller_Front_Action
{
    ...
    /*
     * @TODO: look if this function indexAction is required here 
     */
    ...
    public function add_couponAction()
    {
        ...
        $html = $this->getLayout()
            ...
            ->setTemplate('iksanika/onestepcheckout/shipping_method.phtml')
            ->toHtml();
        ...
        $html = $this->getLayout()
            ...
            ->setTemplate('iksanika/onestepcheckout/payment_method.phtml');

        if(Mage::helper('onestepcheckout')->isEnterprise() && Mage::helper('customer')->isLoggedIn())
        {
            $customerBalanceBlock = $this->getLayout()->createBlock('enterprise_customerbalance/checkout_onepage_payment_additional', 'customerbalance', array('template'=>'iksanika/onestepcheckout/customerbalance/payment/additional.phtml'));
            $customerBalanceBlockScripts = $this->getLayout()->createBlock('enterprise_customerbalance/checkout_onepage_payment_additional', 'customerbalance_scripts', array('template'=>'iksanika/onestepcheckout/customerbalance/payment/scripts.phtml'));

            $rewardPointsBlock = $this->getLayout()->createBlock('enterprise_reward/checkout_payment_additional', 'reward.points', array('template'=>'iksanika/onestepcheckout/reward/payment/additional.phtml', 'before' => '-'));
            $rewardPointsBlockScripts = $this->getLayout()->createBlock('enterprise_reward/checkout_payment_additional', 'reward.scripts', array('template'=>'iksanika/onestepcheckout/reward/payment/scripts.phtml', 'after' => '-'));
        ...
        {
            $giftcardScripts = $this->getLayout()->createBlock('enterprise_giftcardaccount/checkout_onepage_payment_additional', 'giftcardaccount_scripts', array('template'=>'iksanika/onestepcheckout/giftcardaccount/onepage/payment/scripts.phtml'));
        ...
        $html = $this->getLayout()
            ...
            ->setTemplate('iksanika/onestepcheckout/summary.phtml')
            ->toHtml();
    ...
    public function save_billingAction()
    {
        ...
        if (!empty($billing_data['taxvat'])) 
        {
            ...
            $this->_getOnepage()->getQuote()->getBillingAddress()->setTaxId($billing_data['taxvat']);
            $this->_getOnepage()->getQuote()->getBillingAddress()->setVatId($billing_data['taxvat']);
        } else 
        {
