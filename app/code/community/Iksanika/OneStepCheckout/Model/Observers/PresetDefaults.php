...
class Iksanika_OneStepCheckout_Model_Observers_PresetDefaults 
    extends Mage_Core_Model_Abstract 
{
     ...
     * @return Iksanika_OneStepCheckout_Model_Observers_PresetDefaults
     */
    ...
    /**
     * If customer logs in and there are default data that is different from entered 
     * data we need to reset defaults
     *
     * @param Varien_Event_Observer $observer
     */
