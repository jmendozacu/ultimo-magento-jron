...
class Iksanika_OneStepCheckout_Helper_Data 
    extends Mage_Core_Helper_Abstract
{
    ...
    public function setCustomerComment($observer)
    {
        ...
        if($enableComments && $orderComment != "") 
        {
        ...
        if($enableFeedback)
        {
            ...
            {
                $feedbackValue = ($feedbackValue!='freetext') ? $feedbackValues[$feedbackValue]['value'] : $feedbackValueFreetext;
    ...
    {
        return ($value == '-') ? '' : Mage::helper('core')->escapeHtml($value);
    }
}
