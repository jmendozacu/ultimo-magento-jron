<?php
class Iksanika_OneStepCheckout_Helper_Checkout 
    extends Mage_Core_Helper_Abstract
{
    ...
    {
        return ($this->settings['registration_mode'] == 'allow_guest') ? true : false;    
    }
...
//            'general/serial', 
            ...
            'general/default_shipping_method', 
            'general/default_payment_method',
            'general/enable_geoip', 
            'general/skin', 
            'exclude_fields/exclude_city', 
            'exclude_fields/exclude_telephone', 
            'general/show_custom_options',
            'exclude_fields/exclude_company', 
            'exclude_fields/exclude_fax', 
            'exclude_fields/exclude_region', 
            'exclude_fields/exclude_zip', 
            'exclude_fields/enable_comments', 
            'exclude_fields/enable_discount', 
            'exclude_fields/exclude_address', 
            'exclude_fields/exclude_country_id', 
            'exclude_fields/enable_giftcard',
            'general/geoip_database', 
            'exclude_fields/enable_newsletter', 
            'terms/enable_terms',
            'general/checkout_title', 
            'general/checkout_description',
            'sortordering_fields',
            'terms/terms_title', 
            'terms/terms_contents', 
            'general/enable_different_shipping', 
            'ajax_update/enable_ajax_save_billing',
            'ajax_update/ajax_save_billing_fields', 
            'ajax_update/enable_update_payment_on_shipping', 
            'general/enable_gift_messages',
            'registration/registration_mode', 
            'registration/registration_order_without_password', 
            'general/hide_nonfree_payment_methods',
            'general/display_tax_included', 
            'exclude_fields/newsletter_default_checked', 
            'feedback',
            'addressreview',
            'general/display_full_tax',
            'exclude_fields/enable_comments_default',
            'terms/enable_default_terms',
            'terms/enable_default_terms', 
            'terms/enable_textarea'
        );
    ...
    protected function _canUseMethod($method, $quote)
    {
        ...
        return ((!empty($minTotal) && ($total < $minTotal)) || (!empty($maxTotal) && ($total > $maxTotal))) ? false : true;
    }
