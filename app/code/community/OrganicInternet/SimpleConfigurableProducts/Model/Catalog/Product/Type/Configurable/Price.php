...
class OrganicInternet_SimpleConfigurableProducts_Model_Catalog_Product_Type_Configurable_Price
...
*/
		...
		if ($buyRequest) {
			$optionstemp = $product->getCustomOption('info_buyRequest')->getItem()->getOptionByCode('simple_product');
            if($optionstemp == ""){
                return;
            }else{
                $options = $optionstemp->getData();
            }
