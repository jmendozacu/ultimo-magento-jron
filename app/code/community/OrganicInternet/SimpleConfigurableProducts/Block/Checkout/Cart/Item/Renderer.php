<?php
class OrganicInternet_SimpleConfigurableProducts_Block_Checkout_Cart_Item_Renderer
        ...
        if (Mage::getStoreConfig('SCP_options/cart/show_config_product_options')) {
            if ($this->getConfigurableProductParentId()) {
                ...
                foreach($attributes as $attribute) {
                    $options[] = array(
                        'label' => $this->getConfigurableProductParent()->getResource()->getAttribute($attribute->getId())->getStoreLabel(),
