...
class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
{
    ...
    public function updateItemOptionsAction()
    {
        ...
        //FG MODIFY - If SimpleProduct with Parent is Loaded, then Load the Parent-Product
        $parent = Mage::getResourceSingleton('catalog/product_type_configurable')->getParentIdsByChild($productId);
